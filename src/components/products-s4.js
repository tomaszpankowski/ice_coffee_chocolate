...
class ProductsS4 extends Component{
    render(){
        return(    
            <Container fluid className="products-s4 d-flex minh-50vh border-top border-secondary align-items-center py-5 bg-secondary">
